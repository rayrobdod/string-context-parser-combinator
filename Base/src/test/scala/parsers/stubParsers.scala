...
final class ConstSuccess[A](val a:A, val rest:Input[Nothing, StubPosition], val expecting:ExpectingSet[StubPosition], val cut:Cut) extends Parser[Any, A] {
...
final class ConstFailure(val expecting:ExpectingSet[StubPosition], val cut:Cut) extends Parser[Any, Nothing] {
